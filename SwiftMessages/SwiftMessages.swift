    ...
    public enum PresentationContext {
        ...
        */
        ...
        /**
         ...
         to hide it.
        */
        // NOTE: (zacwest fork) first parameter should be UIWindowScene
        // see: https://github.com/SwiftKickMobile/SwiftMessages/issues/471
        case windowScene(_: AnyObject, windowLevel: UIWindow.Level)
